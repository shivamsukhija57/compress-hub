...
def newFile():
    global file
    root.title("Untitled - COMPRESSION HUB")
    file=None
...
def openFile():
    ...
    if file=="":
        ...
        root.title(os.path.basename(file)+" - COMPRESSION HUB")
        textArea.delete(1.0,END)
...
def about():
    showinfo("COMPRESSION HUB"," Made by Shivam Sukhija & Shreyash Kumar")
...
if __name__ == '__main__':
    ...
    textArea.configure(fg='white',bg='black')
    ...
    helpMenu.add_command(label="About Compression Hub",command=about)
